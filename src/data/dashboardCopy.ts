...
const dashboardCopy = {
  en: {
    ...
    chrome: {
      breadcrumb: 'Portfolio / Operating',
      certified: 'Certified model',
      updated: 'Updated 12m ago',
      source: 'Mock operating data',
    },
    sections: {
      filtersTitle: 'Scope filters',
      filtersDetail: 'Adjust app, channel, region, and date without leaving the operating view.',
      summaryTitle: 'Decision summary',
      summaryDetail: 'What matters most in the current slice.',
      metricsTitle: 'KPI watchlist',
      metricsDetail: 'Role-priority signals with clean day-to-day readouts.',
    },
    toolbar: {
      role: 'View',
      language: 'Lang',
  ...
  zh: {
    ...
    sections: {
      filtersTitle: '筛选范围',
      filtersDetail: '按日期、应用、渠道和区域切换视图。',
      summaryTitle: '决策概览',
      summaryDetail: '当前范围下最重要的结论。',
      metricsTitle: '关键指标',
      metricsDetail: '按角色优先级查看核心信号。',
    },
    toolbar: {
      role: '视角',
      language: '语言',
